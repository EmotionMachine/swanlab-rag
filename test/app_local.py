import gradio as gr
from chat_logic_loacl_feishu import Chatbot
import uuid
...
with gr.Blocks(theme=gr.themes.Soft(), css=custom_css, title="SwanLab AI文档助手") as demo:
    ...
    # logo_url = "https://your-domain.com/swanlab.svg"  # 远程 URL 也可以
        ...
        gr.HTML(f"""
                    <div style="display: flex; align-items: center; justify-content: center; flex-direction: row; position: relative;">
                        <div style="display: flex; align-items: center;">
                            ...
                            <h1 style="font-size:50px; color:black;">wanLab Copilot</h1>
                        </div>
                        <div style="font-size: 20px; color: gray; margin-top: 35px; margin-left: 10px;"> (beta)</div>
                    </div>
                    """)
    ...
    with gr.Column(elem_classes="chat-container"):
        ...
        with gr.Column(elem_classes="input-area"):
            ...
            with gr.Row(elem_classes="feedback-area"):
                ...
                feedback_btn = gr.Button("反馈", link="https://chat.swanlab.cn/")
